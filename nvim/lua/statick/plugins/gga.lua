...
-- 2. Crear archivo lua/statick/modules/gga.lua con la implementación
-- 3. Habilitar este archivo eliminando el return vacío
-- 4. Descomentar la configuración en keymaps.lua
